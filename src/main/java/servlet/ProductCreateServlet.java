...
import DoAnhHoang.vn.beans.Product;
import DoAnhHoang.vn.conn.ConnectionUtils;
import DoAnhHoang.vn.utils.ProductUtils;
...
public class ProductCreateServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request,
		...
		RequestDispatcher dispatcher  = request.getServletContext()
				.getRequestDispatcher("/WEB-INF/view/productCreate.jsp");
